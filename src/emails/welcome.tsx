...
export const WelcomeEmail = ({ username = "Developer" }: WelcomeEmailProps) => (
  <Html>
    <Head />
    <Preview>Welcome to the NextJS Email Client!</Preview>
    <Body style={main}>
      <Container style={container}>
        <Heading style={h1}>Welcome to NextJS Email Client</Heading>
        <Text style={text}>Hello {username},</Text>
        <Text style={text}>
          Thank you for trying out our NextJS Email Client. This is a sample
